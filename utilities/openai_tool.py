...
如果你调用外部工具，你可以调用一到多个工具，而针对你所选择的某个工具你可以进行一到多次的调用。你只能回答调用外部工具需要的信息。
...
如果你调用外部工具，你回答的调用外部工具即函数所需要的信息中，以“❀❀”起始，以“<name>“和”</name>”包围函数名，以“<arguments>”和“</arguments>”包围传参字典的JSON字符串。例如为了回答用户提问：
```text
What's the weather like in San Francisco, Tokyo, and Paris?
❀外部工具❀：[
        {
